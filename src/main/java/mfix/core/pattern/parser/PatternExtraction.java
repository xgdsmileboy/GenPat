...
import mfix.core.pattern.relation.op.CopInstof;
import mfix.core.pattern.relation.op.OpArrayAcc;
import mfix.core.pattern.relation.op.OperationFactory;
import mfix.core.pattern.relation.struct.*;
