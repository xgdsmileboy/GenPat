...
//    _errors.add(new ParseException(_currentFile, message, t, null, tokenImage);
  ...
  /**
   * Parses one single lookahead top level statement. This production is
   * not a Java language rule. It is used by DynamicJava.
   *
   * @return a node
   * @see koala.dynamicjava.tree.Node
